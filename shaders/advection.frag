...
// Stream function ψ(uv, t) — curl noise source
...
void main() {
    ...
    // ---- Curl-noise velocity from stream function ----
    ...
    // ---- Optional explicit vortex ----
    if (uVortexActive > 0.5) {
        float Gamma = 0.5;
        vec2 d = vUv - uVortexPos;
        // Rotational velocity: perpendicular to d, decaying with |d|²
    ...
    // Pack velocity into rg for debugging; emission in alpha
